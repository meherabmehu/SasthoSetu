...
def upgrade() -> None:
    ...
    sa.Column('price_bdt', sa.Float(), nullable=False),
    sa.Column('share_with_doctor', sa.Boolean(), server_default=sa.text('true'), nullable=True),
    sa.Column('result_summary', sa.Text(), nullable=True),
    sa.Column('result_values', sa.JSON(), nullable=True),
    sa.Column('result_file_id', sa.String(), nullable=True),
    sa.Column('is_abnormal', sa.Boolean(), server_default=sa.text('false'), nullable=True),
