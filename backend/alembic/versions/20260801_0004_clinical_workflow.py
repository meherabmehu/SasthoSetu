...
def upgrade() -> None:
    ...
    sa.Column('was_overridden', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    ...
    sa.Column('is_signed', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    ...
    sa.Column('is_cancelled', sa.Boolean(), server_default=sa.text('false'), nullable=True),
    sa.ForeignKeyConstraint(['appointment_id'], ['appointments.id'], ),
    sa.ForeignKeyConstraint(['consultation_id'], ['consultations.id'], ),
